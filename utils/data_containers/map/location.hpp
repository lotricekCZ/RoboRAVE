...
#define LOCATION_PT_S 4 // size of point type in location class 


	 
class location
{
	enum{_unknown = 		0b0, 	// presetted points in grid generated by map which must be discovered
	...
	public:
		...
		struct{
			...
			unsigned interest_level:7; 			/* 	level of how much is the point
